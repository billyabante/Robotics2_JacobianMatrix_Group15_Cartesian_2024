...
# Jacobian Sliders
    ...
    # For stand
    d4_velo = Label(J_sw,text=("d4* = "),font=(5),bg="pink",fg="black") 
    d4_slider = Scale(J_sw,from_=0,to_= 0,orient=HORIZONTAL,length=100,sliderlength=10,bg="white",fg="black")
    d4_unit = Label(J_sw,text=("cm/s"),font=(5),bg="pink",fg="black")
